...
var channel_list = node_service + '/channel/list'

var channel_delete = node_service + '/channel/delete'

var channel_save = node_service + '/channel/save'

var channel_detail = node_service + '/channel/detail'

var material_list = node_service + '/material/list'

var material_delete = node_service + '/material/delete'

var material_save = node_service + '/material/save'

var material_detail = node_service + '/material/detail'

var scheduler_list = node_service + '/scheduler/list'

var scheduler_delete = node_service + '/scheduler/delete'

var scheduler_save = node_service + '/scheduler/save'

var scheduler_detail = node_service + '/scheduler/detail'
